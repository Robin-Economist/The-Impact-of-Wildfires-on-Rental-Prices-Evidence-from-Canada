...
\begin{table}[t]
   ...
   \begin{tabular}{lrrrr}
      ...
      \midrule
      $Z_{WL}$ (BC 2017)                & 0.818$^{***}$ & 0.874$^{***}$ & 0.874$^{***}$ & 1.600$^{**}$ \\
